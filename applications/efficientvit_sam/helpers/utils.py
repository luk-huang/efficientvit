...
def get_available_models(runtime):
    model_priority = {"efficientvit-sam-xl1": 1, 
                      "efficientvit-sam-xl0": 2, 
                      "efficientvit-sam-l2": 3, 
                      "efficientvit-sam-l1": 4, 
                      "efficientvit-sam-l0": 5
                      }

    model_storage_loc = {
        PYTORCH: "assets/checkpoints/efficientvit_sam",
        ONNX: "assets/export_models/efficientvit_sam/onnx",
        TENSORRT: "assets/export_models/efficientvit_sam/tensorrt",
    }
