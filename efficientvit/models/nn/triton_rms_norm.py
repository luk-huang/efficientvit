...
try:
    ...
    print("Triton not available. If using a non-tensorrt runtime, ignore.  Otherwise, please ensure triton is installed")
...
if TRITON_AVAILABLE:
    ...
    print("Triton RMSNorm functionality is not available.")