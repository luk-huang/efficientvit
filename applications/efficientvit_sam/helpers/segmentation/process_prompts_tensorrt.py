...
try:
    from applications.efficientvit_sam.helpers.auto_mask_generator import DemoAccelEfficientViTSamAutomaticMaskGenerator
    from applications.efficientvit_sam.helpers.predictors.effvit_sam_tensorrt import TRTEfficientViTSamPredictor
    from applications.efficientvit_sam.deployment.tensorrt.inference import SamResize
